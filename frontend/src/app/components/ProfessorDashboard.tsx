    ...
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pb-20 font-sans bg-[#FAFAFA] dark:bg-prof-bg-base min-h-screen transition-colors duration-200">
      ...
      <section className="mb-14">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="text-sm font-semibold text-blue-600 dark:text-prof-accent-blue hover:text-blue-800 dark:hover:text-blue-400 transition-colors flex items-center gap-1 group">
            Full Timetable <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </button>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {/* Upcoming Class */}
          <div className="bg-white dark:bg-prof-bg-surface rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.03)] dark:shadow-none hover:shadow-[0_20px_40px_rgb(0,0,0,0.06)] dark:hover:shadow-none border border-gray-100 dark:border-prof-border-subtle transition-all duration-300 relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-1.5 h-full bg-blue-500 dark:bg-prof-accent-blue rounded-l-3xl"></div>
            <div className="flex justify-between items-start mb-6">
              <span className="bg-blue-50 dark:bg-prof-accent-blue-soft-bg text-blue-700 dark:text-prof-accent-blue text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                Upcoming
              </span>
            </div>
            <h3 className="text-lg font-bold text-gray-900 dark:text-prof-text-primary mb-2 font-syne">Data Structures (CS201)</h3>
            <p className="text-sm text-gray-500 dark:text-prof-text-secondary flex items-center gap-2 mb-6 font-medium">
              <MapPin className="w-4 h-4 text-gray-400 dark:text-prof-text-tertiary" strokeWidth={2} /> Lecture Hall 3
            </p>
            <div className="text-sm font-bold text-gray-900 dark:text-prof-text-primary">10:00 AM - 11:30 AM</div>
          </div>

          {/* Later Class */}
          <div className="bg-white dark:bg-prof-bg-surface rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.03)] dark:shadow-none hover:shadow-[0_20px_40px_rgb(0,0,0,0.06)] dark:hover:shadow-none border border-gray-100 dark:border-prof-border-subtle transition-all duration-300 relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-1.5 h-full bg-amber-400 dark:bg-prof-accent-orange rounded-l-3xl"></div>
            <div className="flex justify-between items-start mb-6">
               <span className="bg-amber-50 dark:bg-prof-accent-orange-soft-bg text-amber-700 dark:text-prof-accent-orange text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                Later Today
              </span>
            </div>
            <h3 className="text-lg font-bold text-gray-900 dark:text-prof-text-primary mb-2 font-syne">Machine Learning (CS405)</h3>
            <p className="text-sm text-gray-500 dark:text-prof-text-secondary flex items-center gap-2 mb-6 font-medium">
              <MapPin className="w-4 h-4 text-gray-400 dark:text-prof-text-tertiary" strokeWidth={2} /> Lab Room 2
            </p>
            <div className="text-sm font-bold text-gray-900 dark:text-prof-text-primary">02:00 PM - 04:00 PM</div>
          </div>

          {/* Completed Class */}
          <div className="bg-white dark:bg-prof-bg-surface rounded-3xl p-6 shadow-[0_4px_15px_rgb(0,0,0,0.02)] dark:shadow-none border border-gray-100/50 dark:border-prof-border-subtle transition-all duration-300 relative overflow-hidden opacity-75 hover:opacity-100">
            <div className="absolute top-0 left-0 w-1.5 h-full bg-gray-200 dark:bg-prof-border-strong rounded-l-3xl"></div>
            <div className="flex justify-between items-start mb-6">
              <span className="bg-gray-100 dark:bg-prof-bg-surface-raised text-gray-600 dark:text-prof-text-secondary text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                Completed
              </span>
              <CheckCircle2 className="w-5 h-5 text-gray-300 dark:text-prof-border-strong" strokeWidth={2} />
            </div>
            <h3 className="text-lg font-bold text-gray-500 dark:text-prof-text-tertiary mb-2 font-syne line-through decoration-gray-300 dark:decoration-prof-border-strong">Algorithms (CS301)</h3>
            <p className="text-sm text-gray-400 dark:text-prof-text-tertiary flex items-center gap-2 mb-6 font-medium">
              <MapPin className="w-4 h-4 text-gray-300 dark:text-prof-border-strong" strokeWidth={2} /> Lecture Hall 1
            </p>
            <div className="text-sm font-bold text-gray-400 dark:text-prof-text-tertiary">08:00 AM - 09:30 AM</div>
          </div>
        </div>
      </section>
