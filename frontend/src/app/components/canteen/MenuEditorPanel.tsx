...
export const MenuEditorPanel: React.FC<MenuEditorPanelProps> = ({ shop, menuItems, setMenuItems }) => {
  ...
  return (
    <div className="mx-auto max-w-7xl font-sans">
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-3xl border border-slate-100 bg-white p-6 sm:p-8 shadow-[0_2px_16px_rgba(0,0,0,0.03)]">
        <div>
          <h2 className="font-syne text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">
            Menu Management
          </h2>
      ...
      {menuItems.length === 0 ? (
        <div className="rounded-3xl border border-slate-100 bg-white p-16 text-center shadow-[0_2px_16px_rgba(0,0,0,0.03)]">
          <p className="font-syne text-base font-bold text-slate-800">No food items added yet</p>
          <p className="mt-1 text-xs text-slate-500">
      ...
      <AnimatePresence>
        {menuModal.isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="border-b border-slate-100 bg-slate-50/70 p-6 flex items-center gap-3.5">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-amber-50 text-amber-600 border border-amber-100 shadow-2xs">
                  {menuModal.mode === 'add' ? (
              ...
              <div className="space-y-4 p-6 max-h-[65vh] overflow-y-auto">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  />
                  {menuForm.image && (
                    <div className="mt-2.5 h-32 overflow-hidden rounded-2xl border border-slate-100">
                      <img
                        loading="lazy"
                        src={menuForm.image}
                        alt="Preview"
                  ...
                  <input
                    ...
                    className="mt-2 w-full text-xs text-slate-500 file:mr-3 file:rounded-xl file:border-0 file:bg-amber-50 file:px-3 file:py-2 file:font-bold file:text-amber-700 hover:file:bg-amber-100"
                  />
                </div>
