      ...
      {links.map((item, index) => {
        ...
        return (
          <a
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-black/10 bg-[var(--bg)] text-[var(--text-primary)] transition-colors hover:border-[var(--yellow)] hover:bg-[var(--yellow-light)]"
          >
