          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium mt-0.5">
                Managing notices across <span className="font-bold text-slate-700">All Colleges</span>
              </p>
            </div>
          </div>
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 flex-wrap mb-1">
                              ...
                              <h3 className={`font-syne text-sm font-bold leading-snug truncate ${notice.is_deleted ? 'line-through text-slate-500' : 'text-slate-900'}`}>
                                {notice.title}
                              </h3>
                            </div>
                            ...
                            <div className="mt-2.5 p-2 rounded-xl bg-slate-100/80 border border-slate-200/60 text-[10px] font-medium text-slate-500 flex flex-col gap-1">
                                <div className="flex items-center gap-1.5">
                                  <User className="w-3 h-3 text-slate-400" />
                                  <span className="font-bold text-slate-700">Sent by:</span> {notice.author?.name || notice.author?.email || 'Unknown'}
                                </div>
