...
export const NotificationBanner: React.FC = () => {
  ...
  return (
    <div className="fixed left-4 right-4 top-[calc(env(safe-area-inset-top)+1rem)] z-[90] mx-auto max-w-2xl md:left-auto md:right-6 md:max-w-sm select-none">
      <div className="rounded-2xl border border-black/10 bg-[var(--bg)] px-4 py-4 shadow-[0_20px_50px_rgba(13,13,13,0.16)]">
