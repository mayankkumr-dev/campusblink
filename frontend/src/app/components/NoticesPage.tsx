...
const NoticeCard: React.FC<{
  ...
  return (
    <article 
      className={`bg-white border border-gray-100 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-sm transition-all duration-200 active:scale-[0.98] relative overflow-hidden group animate-in fade-in slide-in-from-bottom-4 ${
    ...
    >
      ...
      <div className="p-5 md:p-6 relative pl-6 md:pl-7">
        ...
        <div className="flex items-start justify-between gap-4 mb-2 pr-8">
          <h2 className="text-lg font-extrabold text-gray-900 leading-tight" style={{ fontFamily: 'SF Pro Display, system-ui, -apple-system, sans-serif', letterSpacing: '-0.374px' }}>
            {notice.title}
          </h2>
        </div>
        ...
        {/* Content */}
        <p className={`text-sm text-gray-500 leading-relaxed whitespace-pre-wrap ${!expanded && isLong ? 'line-clamp-2' : ''}`}>
          {notice.content}
        </p>
        {isLong && (
          <button
    ...
    <div className="min-h-full bg-gray-50 pb-12 relative">
      ...
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-gray-100 shadow-sm">
        <div className="max-w-2xl mx-auto px-4 py-3 md:px-6 flex items-center justify-between">
          {!isSearchActive ? (
            <>
              <h1 className="text-xl font-extrabold text-gray-900 tracking-tight" style={{ fontFamily: 'SF Pro Display, system-ui, -apple-system, sans-serif', letterSpacing: '-0.374px' }}>Notices</h1>
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="w-10 h-10 rounded-full flex items-center justify-center hover:bg-gray-100 text-gray-500 transition-colors disabled:opacity-50"
                >
            ...
            <div className="flex items-center gap-2 w-full animate-in fade-in slide-in-from-right-4 duration-200">
              <button 
                ...
                className="w-10 h-10 shrink-0 rounded-full flex items-center justify-center hover:bg-gray-100 text-gray-500 transition-colors"
              >
              ...
              <input
                ...
                className="flex-1 bg-gray-100 border-none text-gray-900 px-4 py-2 rounded-full text-sm font-medium focus:outline-none focus:ring-2 focus:ring-gray-200 placeholder:text-gray-400"
              />
            </div>
          )}
        </div>
      ...
      <div className="max-w-2xl mx-auto px-4 md:px-6 pt-6">
        ...
        {isAdmin && (
          <Link
            ...
            className="mb-6 flex items-center gap-3 px-4 py-3 bg-orange-50 rounded-2xl border border-orange-100 active:scale-[0.99] transition-all group"
          >
            <div className="w-8 h-8 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 shrink-0 group-hover:scale-105 transition-transform">
        ...
        {!isLoading && notices.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            <div className="w-16 h-16 rounded-2xl bg-white border border-gray-100 shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex items-center justify-center text-gray-400 mb-4">
              <Bell className="w-7 h-7 stroke-[1.5]" />
            </div>
            <p className="font-syne text-lg font-bold text-gray-900" style={{ fontFamily: 'SF Pro Display, system-ui, -apple-system, sans-serif' }}>No notices yet</p>
