...
export async function signUp(email, password, name, college, username = '', inviteContext, requestedRole = 'student', professorData = {}, studyYear = null, branch = null) {
  try {
    ...
    if (authError) {
      ...
      if (msg.includes('already registered') || msg.includes('user already registered')) {
        const alreadyError = new Error('This email is already registered. Please login instead.');
        alreadyError.code = 'ALREADY_REGISTERED';
        throw alreadyError;
      }
