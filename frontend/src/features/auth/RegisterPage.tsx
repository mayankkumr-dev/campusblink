...
export const RegisterPage: React.FC = () => {
  ...
  const handleValidateInvite = async () => {
    ...
    try {
      ...
      if (!res.valid || res.error) {
        ...
        // If the invite code carries roster metadata, pre-fill academic fields.
        // This handles roster-tied 1st-year invite codes generated by the admin
        // from the official admission list.
  ...
  const handleStudentRegister = async (e: React.FormEvent) => {
    ...
    const { error: signUpError } = await signUp(
      ...
      studyYear,
      branch,
      // Thread roster-invite fields so the Postgres trigger can set them on the profile
      section || null,
      inviteValidated?.data?.expected_roll_number || null
    );
