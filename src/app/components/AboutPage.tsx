...
export const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-sans p-6 md:p-12 relative overflow-hidden">
      {/* Decorative */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#FFD600]/10 rounded-full blur-[100px]" />
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="prose prose-invert prose-lg">
          <p className="text-xl text-gray-300 leading-relaxed font-syne font-medium">
          ...
          <div className="mt-12 p-8 bg-[#141414] border border-[#ffffff1a] rounded-[2rem]">
            <h3 className="font-syne font-bold text-2xl mb-4 text-[#FFD600]">Made with way too much chai ☕</h3>
            <p className="text-gray-400 text-sm">We're operating out of hostel rooms and local cafes. Zero sleep, 100% passion.</p>
          </div>
        </div>
      </div>
    </div>
