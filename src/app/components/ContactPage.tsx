    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white font-sans p-6 md:p-12 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-12">
          <form onSubmit={handleSubmit} className="bg-[#141414] border border-[#ffffff1a] p-8 rounded-[2rem]">
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full rounded-lg border border-[#ffffff1a] bg-[#0E0E0E] px-4 py-3 text-sm text-white outline-none focus:border-[#FFD600]"
              />
              <input
                type="email"
                value={form.email}
              ...
              <textarea
                ...
                rows={6}
                className="w-full resize-none rounded-lg border border-[#ffffff1a] bg-[#0E0E0E] px-4 py-3 text-sm text-white outline-none focus:border-[#FFD600]"
              />
              <button
                type="submit"
                disabled={isSubmitting}
                className="inline-flex items-center gap-2 rounded-lg bg-[#FFD600] px-5 py-3 text-sm font-bold text-[#0D0D0D] transition-colors hover:bg-[#ffca00] disabled:opacity-60"
              >
          ...
          <div className="bg-[#141414] border border-[#ffffff1a] p-8 rounded-[2rem] hover:border-[#FFD600]/40 transition-colors group">
            <div className="w-12 h-12 rounded-lg bg-[#0A0A0A] flex items-center justify-center mb-6 border border-[#ffffff1a] group-hover:scale-110 transition-transform">
            ...
            <a href="mailto:contactus.mayank@gmail.com" className="font-bold text-[#FFD600] hover:underline">contactus.mayank@gmail.com</a>
