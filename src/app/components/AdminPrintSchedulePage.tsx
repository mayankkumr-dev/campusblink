...
export const AdminPrintSchedulePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <button onClick={() => navigate('/admin/print')} className="inline-flex items-center gap-2 rounded-lg border border-black/[0.08] bg-white px-4 py-2 text-sm font-bold text-[#0D0D0D] hover:bg-[#F7F5F0]">
        <ArrowLeft className="h-4 w-4" /> Back to print shops
      </button>

      <div className="rounded-lg border border-black/[0.08] bg-white p-6">
        <h1 className="font-syne text-2xl font-bold text-[#0D0D0D]">{shop?.name || 'Print shop'} schedule</h1>
